...
export default function MarqueeSection() {
  return (
    <section aria-label="Brands and Clients" className="bg-[#0C0C0C] flex flex-col justify-center overflow-hidden pt-20 pb-24 sm:py-32 md:py-40 relative z-10 border-t border-white/5">
      <div data-nosnippet>
        {/* Header */}
