      ...
      <div className="max-w-7xl mx-auto w-full z-20 relative">
        ...
        <div className="flex flex-col lg:hidden w-full gap-8 z-30 pt-10">
          ...
          <div className="grid grid-cols-[55%_45%] gap-4 items-center">
            {/* Left: Heading & Title */}
            <div className="flex flex-col justify-center text-[#1A1A1A]">
              <FadeIn delay={0.1} y={20}>
                <h2 className="font-black leading-[1] tracking-tight text-[clamp(2.5rem,9.5vw,4.2rem)] whitespace-nowrap font-display">
                  Namaste ji,
                </h2>
              </FadeIn>
              
              <FadeIn delay={0.2} y={20} className="relative w-fit mt-1 sm:mt-2">
                <h3 className="text-[clamp(1.4rem,5vw,2.8rem)] tracking-normal font-display whitespace-nowrap">
                  ...
                  <span className="font-semibold relative inline-block">
                    ...
                    <div className="absolute bg-[#FFFF00] w-full h-[6px] sm:h-[8px] bottom-[10%] left-0 z-0"></div>
                  </span>
                </h3>
              </FadeIn>

              <FadeIn delay={0.3} y={15} className="mt-8 sm:mt-10">
                <span className="text-[clamp(1.4rem,5vw,2.5rem)] text-[#444] italic font-['Caveat']">
                  Creative Designer
                </span>
              </FadeIn>
            </div>
